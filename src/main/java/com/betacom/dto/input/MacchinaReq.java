...
public class MacchinaReq extends VeicoloReq {
	@NotNull (groups = ValidationGroups.Update.class , message ="idmc.no.car")
	...
	@NotNull (groups = ValidationGroups.Create.class , message ="nrporte.no.car")
    private Integer numeroPorte;
	@NotNull(groups = ValidationGroups.Create.class, message = "targa.no.car")
	@Pattern(
